...
public class Loginver2 extends JFrame implements ActionListener {
		//선언
...
//					bdao.procLogin(mem_id, mem_pw);
					...
					tc = new ChatClientver2(this);//생성자 호출 - 화면처리 하기 호출 - 소켓생성
//					tc.initDisplay();
//					tc.init();
				}
			}////////////////////////end of login
