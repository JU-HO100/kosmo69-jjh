...
public class ZipCodeSearch extends JFrame implements ItemListener,FocusListener,ActionListener, MouseListener {
   ...
   String zdos3[]=null;
   ChatMemberShip cms = null;
         //생성자
   public ZipCodeSearch() {
            zdos3=getZdoList();
         }
   public ZipCodeSearch(ChatMemberShip cms) {
	   this();
	   this.cms = cms;
   }
//화면처리부
		...
		public void mousePressed(MouseEvent e) {
			if(e.getClickCount()>=2) {
				...
				return;
					...
					cms.jtf_zipcode.setText(String.valueOf(zipcode));
					cms.jtf_address.setText(String.valueOf(address));
					this.dispose();
//					refreshData();
				}
			}
