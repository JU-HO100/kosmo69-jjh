...
import movieteamX.MovieEvent2;
import nickname.ZipCodeVO;

public class MovieZipCodeSearch extends JFrame implements ItemListener,FocusListener,ActionListener, MouseListener {
   //선언부
   String zdo=null;
...
//   JComboBox jcb_zdo2=null;//West
   ...
   SignupEvent se = null;
         ...
         //생성자
   public MovieZipCodeSearch(SignupEvent signupEvent) {
	   this.se = signupEvent;
   }
   public MovieZipCodeSearch() {
           zdos3=getZdoList();
         }
...
//화면처리부
   ...
   public static void main(String[] args) {
      MovieZipCodeSearch mzcs=new MovieZipCodeSearch();
      mzcs.initDisplay();
