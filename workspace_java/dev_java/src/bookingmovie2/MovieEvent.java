...
////////////////////////////////스케줄선택화면 ///////////////////////////////////
        if (obj == d.jb_p) {
			...
			if(index.length == 0) {
				...
				String seat_code = msdao.getSeatCode(date, time);
...
//			 mdao = new MovieDAO();
			...
			d.Pay();
			d.mjf.dispose();
			pdao.payInfo(d.id_t.getText(), mcode);
			d.jta_num.setText(pdao.sVO.getT_BOOKNUM());
			d.jta_movie.setText(pdao.sVO.getTITLE());
			d.jta_day.setText(pdao.sVO.getM_TIME());
			d.jta_seat.setText(pdao.sVO.getSEAT1()+", "+pdao.sVO.getSEAT2()+", "+pdao.sVO.getSEAT3()+", "+pdao.sVO.getSEAT4());
			d.jta_pay.setText(pdao.sVO.getPRICE());
		}////////// end of if(d.mjbtn_next)
