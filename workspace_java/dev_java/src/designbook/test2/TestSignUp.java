...
public class TestSignUp extends JDialog{
	...
	TestSignEvent se = new TestSignEvent(this); //회원가입페이지 이벤트연결
	LoginEvent le = null;
	

	public TestSignUp() {}
	public TestSignUp(LoginEvent le) {
		this.le = le;
	}
