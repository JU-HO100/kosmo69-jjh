...
public class ApiExamCaptchaImage2 {
//생성자 추가하기 - 
	public ApiExamCaptchaImage2(String key) {
    ...
    public static void main(String[] args) {
        ...
        String key = "sVo9ahtuMv5kipWp"; // https://openapi.naver.com/v1/captcha/nkey 호출로 받은 키값
