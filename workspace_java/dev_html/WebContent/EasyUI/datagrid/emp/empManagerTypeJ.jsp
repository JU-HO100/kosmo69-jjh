...
//        		$("#d_msg").append('target:'+target);
       ...
       function zipCode(){
    	   var data = [];
       		$('#dg_zipcode').datagrid('loadData', data);
       		$('#dong').textbox("setValue",'');
...
// 						alert("확인"+g_address+g_zip);
						$("#zipcode").textbox('setValue',g_zip);
	   ...
	   $('#tb_keyword').textbox('textbox').bind('keydown', function(e){
	   	...
	   	$('#dg_zipcode').datagrid({
	   		...
	   		,columns:[[
	   			...
	   			,{field:'address',title:'주소번지',width:380, align:'center', editor:'text'}
	   		]]
	   	});
	   //콤보박스 초기화 및 설정하기
         $("#cb_gubun").combobox({
...
<div  id="dlg_zipcode" name="dlg_zipcode" style="width:600px; padding:30px 30px;" class="easyui-dialog" data-options="closed:'true', title:'주소찾기'">
         <div>
	         <input id="dong" class="easyui-textbox" name="dong" data-options="prompt:'동을 입력해주세요'" style="width:400px">
	         <a id="btn_search" href="javascript:zipcode_search()" class="easyui-linkbutton">찾기</a>
	         <table id="dg_zipcode" class="esayui-datagrid" width="550" height="700" title="주소찾기"></table>
	         <a data-options="closed:true"></a>
         </div>
</div>
...
<div id="dlg_upd" name="dlg_upd" style="width:600px; padding:30px 30px;" class="easyui-dialog" data-options="closed:'true', title:'사원정보 수정', footer:'#d_upd'">
   <form id="f_empupd">
         ...
         <a id="btn_zipcode" href="javascript:zipCode()" class="easyui-linkbutton">우편번호찾기</a>
         </div>
         <div style="margin-bottom:10px">
