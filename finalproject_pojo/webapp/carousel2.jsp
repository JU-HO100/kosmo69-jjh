				...
				<div class="carousel-inner" style="height: 300px;">
					<div class="carousel-item active">
						<div style="margin-left: 80px;">
							<div style="float: left;">
								...
								<h2 style="font-family: 'Nanum Pen Script', cursive; padding-left: 10px; text-align: center">오성근 셰프님</h2>
							</div>
							<div style="float: left;">
								<img src="/images/chef.png" style="width:150px; border-radius: 50%; border: solid 1px black; margin: 30px;">
								<h2 style="font-family: 'Nanum Pen Script', cursive; padding-left: 10px; text-align: center">박한규 셰프님</h2>
							</div>
							<div style="float: left;">
								<img src="/images/chef.png" style="width:150px; border-radius: 50%; border: solid 1px black; margin: 30px;">
					...
					<div class="carousel-item">
						<div style="margin-left: 80px;">
							...
							<div style="float: left;">
								<img src="/images/chef2.png" style="width:150px; border-radius: 50%; border: solid 1px black; margin: 30px;">
								<h2 style="font-family: 'Nanum Pen Script', cursive; padding-left: 10px; text-align: center">양재화 셰프님</h2>
							</div>
							<div style="float: left;">
								<img src="/images/chef2.png" style="width:150px; border-radius: 50%; border: solid 1px black; margin: 30px;">
								<h2 style="font-family: 'Nanum Pen Script', cursive; padding-left: 10px; text-align: center">이해민 셰프님</h2>
							</div>
							<div style="float: left;">
								<img src="/images/chef2.png" style="width:150px; border-radius: 50%; border: solid 1px black; margin: 30px;">
								<h2 style="font-family: 'Nanum Pen Script', cursive; padding-left: 10px; text-align: center">최호연 셰프님</h2>
